...
Generator modification capacity: the ability of a system to improve the mechanisms that produce solutions.

\[
\Omega
\]

Evolutionary velocity: the rate at which the system improves its own capability-generation dynamics.
