...
The policy converts internal representations and objectives into interventions.
...
The adaptive trajectory depends not only on available actions, but also on which transformations are selected.
